"""IO Simulator service minimal loop.

On start: publishes retained hello world to `io-simulator/status` (QoS 2).
Loop: publishes current epoch seconds to `io-simulator/scan_time` every 5 seconds.
"""
...
BROKER_PORT = 1883
STATUS_TOPIC = "io-simulator/status"
SCAN_TOPIC = "io-simulator/scan_time"
